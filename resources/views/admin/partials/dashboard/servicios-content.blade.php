...
<div class="dashboard-header-card mb-4 p-4 p-xl-5">
    <div class="d-flex flex-column flex-xl-row justify-content-between gap-4 align-items-start align-items-xl-center">
        <div class="dashboard-header-copy">
            ...
            <h2 class="dashboard-heading">Publicidad de Servicios</h2>
            <p class="dashboard-description mb-0">Visión estratégica para analizar rendimiento, publicaciones y comportamiento comercial de los servicios publicitarios.</p>
        </div>
...
<div class="row g-4 mb-4">
    <div class="col-12 col-sm-6 col-xl-3">
        <x-admin.dashboard-indicator-card title="Total de publicaciones" value="{{ number_format($summary['totalServices'] ?? 0) }}" meta="Total de servicios publicados." icon="bi-bar-chart-fill" colorClass="text-primary" />
    </div>
    <div class="col-12 col-sm-6 col-xl-3">
        <x-admin.dashboard-indicator-card title="Aprobados" value="{{ number_format($summary['approvedServices'] ?? 0) }}" meta="Servicios aprobados." icon="bi-check2-circle" colorClass="text-success" />
    </div>
    <div class="col-12 col-sm-6 col-xl-3">
        <x-admin.dashboard-indicator-card title="Rechazados" value="{{ number_format($summary['rejectedServices'] ?? 0) }}" meta="Servicios rechazados." icon="bi-x-circle" colorClass="text-danger" />
    </div>
    <div class="col-12 col-sm-6 col-xl-3">
        <x-admin.dashboard-indicator-card title="Desactivados" value="{{ number_format($summary['deletedServices'] ?? 0) }}" meta="Servicios desactivados." icon="bi-trash-fill" colorClass="text-secondary" />
    </div>
    <div class="col-12 col-sm-6 col-xl-3">
        <x-admin.dashboard-indicator-card title="Publicaciones destacadas" value="{{ number_format($summary['featuredServices'] ?? 0) }}" meta="Publicaciones con mayor visibilidad." icon="bi-star-fill" colorClass="text-warning" />
    </div>
    <div class="col-12 col-sm-6 col-xl-3">
        <x-admin.dashboard-indicator-card title="Empresas anunciantes" value="{{ number_format($summary['totalCompanies'] ?? 0) }}" meta="Empresas activas en servicios." icon="bi-building" colorClass="text-info" />
    </div>
    <div class="col-12 col-sm-6 col-xl-3">
    ...
    <div class="col-12 col-sm-6 col-xl-3">
        <x-admin.dashboard-indicator-card title="Clics" value="{{ number_format($summary['totalClicks'] ?? 0) }}" meta="Interacciones de clics en servicios." icon="bi-mouse-fill" colorClass="text-primary" />
    </div>
    <div class="col-12 col-sm-6 col-xl-3">
    ...
    <div class="col-12 col-sm-6 col-xl-3">
        <x-admin.dashboard-indicator-card title="Creados en el período" value="{{ number_format($summary['createdDuringPeriod'] ?? 0) }}" meta="Publicaciones registradas en el rango seleccionado." icon="bi-calendar-fill" colorClass="text-primary" />
    </div>
    <div class="col-12 col-sm-6 col-xl-3">
        <x-admin.dashboard-indicator-card title="Próximos a vencer" value="{{ number_format($summary['expiringServices'] ?? 0) }}" meta="Publicaciones con vencimiento cercano." icon="bi-exclamation-triangle-fill" colorClass="text-danger" />
    </div>
</div>

<div class="row g-4 mb-4">
    <div class="col-12 col-xl-7">
        <x-admin.dashboard-chart-card id="servicesByMonthChart" title="Evolución mensual de publicaciones" description="Publicaciones activas en el período seleccionado." />
    </div>
    <div class="col-12 col-xl-5">
        <div class="row g-4">
            <div class="col-12">
    ...
    <div class="col-12 col-xl-6">
        <div class="chart-card h-100">
            <div class="chart-header">
                ...
                <p>Comparativa de volumen por categoría de servicio.</p>
            </div>
                ...
                <div class="info-card h-100 p-4">
                    <div class="d-flex align-items-start justify-content-between mb-3">
                        <div>
                            ...
                            <h5 class="mb-1">Servicios más vistos</h5>
                        </div>
                        <span class="badge badge-pill badge-primary-alt">Top 5</span>
                    </div>
                    <div class="list-group list-group-flush">
                        @foreach($topServicesByViews as $service)
                            <div class="list-group-item px-0 py-3 border-0">
                                <div class="d-flex align-items-center justify-content-between gap-3">
                                    <div>
                                        <div class="fw-semibold text-white">{{ $service['nombre_servicio'] }}</div>
                                        <small class="text-muted">{{ $service['nombre_empresa'] }}</small>
                                    </div>
                                    <span class="badge badge-pill badge-surface">{{ number_format($service['metric']) }}</span>
                                </div>
                            </div>
                        @endforeach
                    </div>
            ...
            <div class="col-12">
                <div class="info-card h-100 p-4">
                    <div class="d-flex align-items-start justify-content-between mb-3">
                        <div>
                            <p class="text-uppercase text-muted small mb-1">Ranking</p>
                            <h5 class="mb-1">Servicios con más clics</h5>
                        </div>
                        <span class="badge badge-pill badge-success-alt">Top 5</span>
                    </div>
                    <div class="list-group list-group-flush">
                        @foreach($topServicesByClicks as $service)
                            <div class="list-group-item px-0 py-3 border-0">
                                <div class="d-flex align-items-center justify-content-between gap-3">
                                    <div>
                                        <div class="fw-semibold text-white">{{ $service['nombre_servicio'] }}</div>
            ...
            <div class="list-group list-group-flush">
                @foreach($expiringPublications as $publication)
                    <div class="list-group-item px-0 py-3 border-0">
                        <div class="d-flex align-items-center justify-content-between gap-3">
                            <div>
                                <div class="fw-semibold text-white">{{ $publication['nombre_servicio'] }}</div>
