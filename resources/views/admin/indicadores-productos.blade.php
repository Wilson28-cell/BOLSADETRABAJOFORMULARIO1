...
<style>
    ...
    .products-dashboard-header h2 {
        font-size: 2.25rem;
        font-weight: 700;
        color: #102a43;
    }

    .products-dashboard-header p {
        color: #52606d;
        font-size: 1rem;
    }
    ...
    .products-chart-card .chart-header h3 {
        font-size: 1.2rem;
        font-weight: 700;
        color: #102a43;
    }

    .products-chart-card .chart-header p {
        color: #627d98;
        margin-top: 0.35rem;
        font-size: 0.95rem;
    }
    ...
    .products-insight-meta {
        color: #627d98;
        font-size: 0.95rem;
        margin-bottom: 1.2rem;
    }

    .products-insight-value {
        font-size: 3rem;
        font-weight: 800;
        color: #2064f4;
        margin-bottom: 0.5rem;
    ...
    .products-insight-label {
        color: #334e68;
        font-size: 0.95rem;
    }

    .products-insight-badge {
        display: inline-flex;
        align-items: center;
        gap: 0.35rem;
...
<div class="products-dashboard-page">
    <div class="products-dashboard-header mb-4">
        <h2>Publicidad de Productos</h2>
        <p>Panel ejecutivo para analizar el rendimiento de la publicidad de productos con foco en decisiones municipales.</p>
    </div>
