...
<div class="porvenir-hero">
    ...
    <div class="porvenir-content">
        ...
        <div class="porvenir-actions">
            <a href="{{ url('/publicidad/bolsa-trabajo') }}" class="porvenir-card">
                <div class="card-top">
                    <div class="card-icon">
            ...
            <a href="{{ url('/publicidad/productos') }}" class="porvenir-card">
                <div class="card-top">
                    <div class="card-icon">
                        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ url('/publicidad/servicios') }}" class="porvenir-card">
                <div class="card-top">
                    <div class="card-icon">
                        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
